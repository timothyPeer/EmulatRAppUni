// ============================================================================
// ADDL_InstructionGrain.h - ADDL Instruction Grain
// ============================================================================
...
// ============================================================================
//
//  Instruction: ADDL - ADDL
//  Opcode: 0x10, Function: 0x0000
//  Execution Box: EBox
...
#ifndef ADDL_INSTRUCTIONGRAIN_H
#define ADDL_INSTRUCTIONGRAIN_H
...
namespace {
    static GrainAutoRegistrar<ADDL_InstructionGrain> s_addl_registrar(
        0x10, 0x0000
    );
}

#endif // ADDL_INSTRUCTIONGRAIN_H
