...
// ============================================================================
// SRL Instruction Grain
// ============================================================================

class SRL_InstructionGrain : public InstructionGrain
{
public:
    SRL_InstructionGrain()
        : InstructionGrain(
...
namespace {
    static GrainAutoRegistrar<SRL_InstructionGrain> s_srl_registrar(
        0x12, 0x0034
    );
}

#endif // SRL_INSTRUCTIONGRAIN_H
