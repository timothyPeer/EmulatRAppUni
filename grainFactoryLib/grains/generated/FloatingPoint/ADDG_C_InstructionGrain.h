...
#ifndef ADDG_C_INSTRUCTIONGRAIN_H
...
// ============================================================================
// ADDG_C Instruction Grain
// ============================================================================

class ADDG_C_InstructionGrain : public InstructionGrain
{
public:
    ADDG_C_InstructionGrain()
        : InstructionGrain(
...
namespace {
    static GrainAutoRegistrar<ADDG_C_InstructionGrain> s_addg_c_registrar(
        0x15, 0x0020
    );
}

#endif // ADDG_C_INSTRUCTIONGRAIN_H
